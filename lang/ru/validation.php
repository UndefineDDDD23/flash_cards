...
return [
    ...
    | такие как правила размера. Вы можете изменить каждое из этих сообщений.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Значение :attribute найдено в утечке данных. Выберите другое значение.',
    ],
    ...
    | используя соглашение "attribute.rule". Это позволяет быстро задать
    | индивидуальное сообщение для конкретного правила.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие строки используются для замены плейсхолдера :attribute
    | на более читабельное название, например, "E-Mail" вместо "email".
    |
    */
